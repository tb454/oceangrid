/**
   @file MPU9250_wake_on_motion_interrupt.ino
   @author rakwireless.com
   @brief This sketch shows how to use the wake-on-motion interrupt.
...
void setup() {
  ...
  */
  myMPU9250.setWakeOnMotionThreshold(255);  // 128 = ~0.5 g
