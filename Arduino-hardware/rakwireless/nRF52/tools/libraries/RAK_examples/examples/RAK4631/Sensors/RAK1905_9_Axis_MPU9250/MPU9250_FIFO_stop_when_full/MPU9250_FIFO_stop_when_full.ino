...
/**
   @file MPU9250_FIFO_stop_when_full.ino
   @author rakwireless.com
   @brief This sketch shows how to use the Fifo in the "stop when full mode".
          The MPU9250 stops writing samples into the Fifo, when it is full or stopped
          manually. You can vary the "recording" time by modifying the sample rate divider or by choosing the high speed modes (disableGyrDLPF()).
          The Fifo can take up to 42 samples of acceleration and gyroscope data or 85 samples of acceleration or gyroscope data.
   @version 0.1
   @date 2022-03-17
